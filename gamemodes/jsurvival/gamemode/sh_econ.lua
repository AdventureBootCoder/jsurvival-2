...
JSMod.ResourceToJBux = {
    ...
    [JMod.EZ_RESOURCE_TYPES.FISSILEMATERIAL] = 2000,
	[JMod.EZ_RESOURCE_TYPES.TUNGSTEN] = 3,
    [JMod.EZ_RESOURCE_TYPES.CERAMIC] = 5,
    [JMod.EZ_RESOURCE_TYPES.GAS] = 2,
    [JMod.EZ_RESOURCE_TYPES.CLOTH] = 0.4,
    [JMod.EZ_RESOURCE_TYPES.ADVANCEDTEXTILES] = 0.6,
    [JMod.EZ_RESOURCE_TYPES.NUTRIENTS] = 0.6,
    [JMod.EZ_RESOURCE_TYPES.COOLANT] = 1.1,
    [JMod.EZ_RESOURCE_TYPES.MEDICALSUPPLIES] = 1.6,
    [JMod.EZ_RESOURCE_TYPES.AMMO] = 1.6,
    [JMod.EZ_RESOURCE_TYPES.MUNITIONS] = 2.7,
